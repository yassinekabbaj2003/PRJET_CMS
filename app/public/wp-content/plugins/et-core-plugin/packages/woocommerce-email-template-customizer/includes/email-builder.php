...
//						$img = VIWEC_IMAGES . $slug . '.png';
	...
	public function add_edit_buttons( $email ) {
		...
		echo sprintf( "<td><a href='%1s' class='button alignright'>%2s</a></td>", esc_url( $href ), sprintf(esc_html__( 'Edit with %s Email Builder', 'xstore-core' ), apply_filters('etheme_theme_label', 'XStore')) );
	}
