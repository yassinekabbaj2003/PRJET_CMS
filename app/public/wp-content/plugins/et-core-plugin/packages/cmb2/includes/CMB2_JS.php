...
class CMB2_JS {
	...
	protected static function colorpicker_frontend() {
		...
		wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
			'clear'         => esc_html__( 'Clear', 'xstore-core' ),
			'defaultString' => esc_html__( 'Default', 'xstore-core' ),
			'pick'          => esc_html__( 'Select Color', 'xstore-core' ),
			'current'       => esc_html__( 'Current Color', 'xstore-core' ),
		) );
	}
		...
		$l10n = array(
			...
			'defaults'          => array(
				...
				'date_picker'  => array(
					'changeMonth'     => true,
					'changeYear'      => true,
					'dateFormat'      => _x( 'mm/dd/yy', 'Valid formatDate string for jquery-ui datepicker', 'xstore-core' ),
					'dayNames'        => explode( ',', esc_html__( 'Sunday, Monday, Tuesday, Wednesday, Thursday, Friday, Saturday', 'xstore-core' ) ),
					'dayNamesMin'     => explode( ',', esc_html__( 'Su, Mo, Tu, We, Th, Fr, Sa', 'xstore-core' ) ),
					'dayNamesShort'   => explode( ',', esc_html__( 'Sun, Mon, Tue, Wed, Thu, Fri, Sat', 'xstore-core' ) ),
					'monthNames'      => explode( ',', esc_html__( 'January, February, March, April, May, June, July, August, September, October, November, December', 'xstore-core' ) ),
					'monthNamesShort' => explode( ',', esc_html__( 'Jan, Feb, Mar, Apr, May, Jun, Jul, Aug, Sep, Oct, Nov, Dec', 'xstore-core' ) ),
					'nextText'        => esc_html__( 'Next', 'xstore-core' ),
					'prevText'        => esc_html__( 'Prev', 'xstore-core' ),
					'currentText'     => esc_html__( 'Today', 'xstore-core' ),
					'closeText'       => esc_html__( 'Done', 'xstore-core' ),
					'clearText'       => esc_html__( 'Clear', 'xstore-core' ),
				),
				'time_picker'  => array(
					'timeOnlyTitle' => esc_html__( 'Choose Time', 'xstore-core' ),
					'timeText'      => esc_html__( 'Time', 'xstore-core' ),
					'hourText'      => esc_html__( 'Hour', 'xstore-core' ),
					'minuteText'    => esc_html__( 'Minute', 'xstore-core' ),
					'secondText'    => esc_html__( 'Second', 'xstore-core' ),
					'currentText'   => esc_html__( 'Now', 'xstore-core' ),
					'closeText'     => esc_html__( 'Done', 'xstore-core' ),
					'timeFormat'    => _x( 'hh:mm TT', 'Valid formatting string, as per http://trentrichardson.com/examples/timepicker/', 'xstore-core' ),
					'controlType'   => 'select',
					'stepMinute'    => 5,
				),
			),
			'strings' => array(
				'upload_file'  => esc_html__( 'Use this file', 'xstore-core' ),
				'upload_files' => esc_html__( 'Use these files', 'xstore-core' ),
				'remove_image' => esc_html__( 'Remove Image', 'xstore-core' ),
				'remove_file'  => esc_html__( 'Remove', 'xstore-core' ),
				'file'         => esc_html__( 'File:', 'xstore-core' ),
				'download'     => esc_html__( 'Download', 'xstore-core' ),
				'check_toggle' => esc_html__( 'Select / Deselect All', 'xstore-core' ),
			),
		);
