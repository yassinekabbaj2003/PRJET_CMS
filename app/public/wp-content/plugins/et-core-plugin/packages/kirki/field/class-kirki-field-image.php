...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__( 'Select image', 'xstore-core' ),
				'change'       => esc_html__( 'Change image', 'xstore-core' ),
				'default'      => esc_html__( 'Default', 'xstore-core' ),
				'remove'       => esc_html__( 'Remove', 'xstore-core' ),
				'placeholder'  => esc_html__( 'No image selected', 'xstore-core' ),
				'frame_title'  => esc_html__( 'Select image', 'xstore-core' ),
				'frame_button' => esc_html__( 'Choose image', 'xstore-core' ),
			)
		);
	}
