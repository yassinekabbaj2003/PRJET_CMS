...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_html__( 'Ultra-Light 100', 'xstore-core' ),
			'100light'  => esc_html__( 'Ultra-Light 100', 'xstore-core' ),
			'100italic' => esc_html__( 'Ultra-Light 100 Italic', 'xstore-core' ),
			'200'       => esc_html__( 'Light 200', 'xstore-core' ),
			'200italic' => esc_html__( 'Light 200 Italic', 'xstore-core' ),
			'300'       => esc_html__( 'Book 300', 'xstore-core' ),
			'300italic' => esc_html__( 'Book 300 Italic', 'xstore-core' ),
			'400'       => esc_html__( 'Normal 400', 'xstore-core' ),
			'regular'   => esc_html__( 'Normal 400', 'xstore-core' ),
			'italic'    => esc_html__( 'Normal 400 Italic', 'xstore-core' ),
			'500'       => esc_html__( 'Medium 500', 'xstore-core' ),
			'500italic' => esc_html__( 'Medium 500 Italic', 'xstore-core' ),
			'600'       => esc_html__( 'Semi-Bold 600', 'xstore-core' ),
			'600bold'   => esc_html__( 'Semi-Bold 600', 'xstore-core' ),
			'600italic' => esc_html__( 'Semi-Bold 600 Italic', 'xstore-core' ),
			'700'       => esc_html__( 'Bold 700', 'xstore-core' ),
			'700italic' => esc_html__( 'Bold 700 Italic', 'xstore-core' ),
			'800'       => esc_html__( 'Extra-Bold 800', 'xstore-core' ),
			'800bold'   => esc_html__( 'Extra-Bold 800', 'xstore-core' ),
			'800italic' => esc_html__( 'Extra-Bold 800 Italic', 'xstore-core' ),
			'900'       => esc_html__( 'Ultra-Bold 900', 'xstore-core' ),
			'900bold'   => esc_html__( 'Ultra-Bold 900', 'xstore-core' ),
			'900italic' => esc_html__( 'Ultra-Bold 900 Italic', 'xstore-core' ),
		);
	}
