...
class St_Woo_Swatches_Admin extends St_Woo_Swatches_Base {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, $this->plugin_admin_dir_path_url . 'js/admin.min.js', array( 'jquery', 'wp-color-picker' ), $this->version, false );
	}
