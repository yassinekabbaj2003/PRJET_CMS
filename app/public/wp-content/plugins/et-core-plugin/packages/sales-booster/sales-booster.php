        ...
        public function render_content() {
            ...
            foreach ($products_rendered as $product_rendered) {
                ...
                if ( isset( $local_settings['fake_sale_popup_image'] ) && $local_settings['fake_sale_popup_image'] ):
                    $product_options['src'] = wp_get_attachment_image_src( get_post_thumbnail_id( $product_rendered['id'], 'woocommerce_gallery_thumbnail' ) );

                    if ( $product_rendered['type'] == 'variation' ) {
                        $product_options['src'] = wp_get_attachment_image_src( $product_rendered['image_id'], 'woocommerce_gallery_thumbnail' );
                    }
