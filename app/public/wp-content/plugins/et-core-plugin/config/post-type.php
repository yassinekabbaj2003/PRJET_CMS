...
/**
 *	Linked Variations Post Type
 */
add_filter( 'etc/add/post/args', 'etc_add_posttype_linked_variations' );
function etc_add_posttype_linked_variations( $args ) {
	...
	$args[] = array(
		'register_name'      => 'etheme_linked_var',
		'name'          	 => esc_html_x( 'Linked Variations', 'post type general name', 'xstore-core' ),
		'singular_name' 	 => esc_html_x( 'Linked Variation', 'post type singular name', 'xstore-core' ),
		'add_new'       	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Linked Variation', 'xstore-core' ) ),
		'add_new_item'  	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Linked Variation', 'xstore-core' ) ),
		'edit_item' 		 => sprintf( esc_html__( 'Edit %s', 'xstore-core' ),esc_html__( 'Linked Variation`', 'xstore-core' ) ),
		'new_item' 			 => sprintf( esc_html__( 'New %s', 'xstore-core' ), esc_html__( 'Linked Variation', 'xstore-core' ) ),
		'all_items' 		 => sprintf( esc_html__( '%s %s', 'xstore-core' ), apply_filters('etheme_theme_label', 'XStore'), esc_html__( 'Linked Variations', 'xstore-core' ) ),
		'view_item' 		 => false, //sprintf( esc_html__( 'View %s', 'xstore-core' ), esc_html__( 'Linked Variations', 'xstore-core' ) ),
		'search_items'  	 => sprintf( esc_html__( 'Search %s', 'xstore-core' ), esc_html__( 'Linked Variations', 'xstore-core' ) ),
		'not_found' 		 => sprintf( esc_html__( 'No %s Found', 'xstore-core' ), esc_html__( 'Linked Variations', 'xstore-core' ) ),
		'not_found_in_trash' => sprintf( esc_html__( 'No %s Found In Trash', 'xstore-core' ), esc_html__( 'Linked Variations', 'xstore-core' ) ),
		'parent_item_colon'  => '',
		'menu_name' 		 => esc_html__( 'Linked Variations', 'xstore-core' ),
		'public' 			 => true,
		'publicly_queryable' => false,
		'show_ui' 			 => true,
		'show_in_menu' 		 => 'edit.php?post_type=product',
		'query_var'          => true,
		'rewrite'            => array( 'slug' => 'etheme_linked_var' ),
		'capability_type'    => 'product',
		'has_archive'        => false,
		'hierarchical'       => false,
		'description'        => 'Custom description zone',
 ...
 *	Mega Menu Post Type
 */
add_filter( 'etc/add/post/args', 'etc_add_posttype_mega_menus_args' );
function etc_add_posttype_mega_menus_args( $args ) {

    if( ! get_theme_mod( 'etheme_mega_menus', true ) || !defined( 'ELEMENTOR_VERSION' ) ) {
        return $args;
    }

    $args[] = array(
        'register_name'      => 'etheme_mega_menus',
        'name'          	 => esc_html_x( 'Mega Menus', 'post type general name', 'xstore-core' ),
        'singular_name' 	 => esc_html_x( 'Mega Menu', 'post type singular name', 'xstore-core' ),
        'add_new'       	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Mega menu', 'xstore-core' ) ),
        'add_new_item'  	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Mega menu', 'xstore-core' ) ),
        'edit_item' 		 => sprintf( esc_html__( 'Edit %s', 'xstore-core' ),esc_html__( 'Mega menu', 'xstore-core' ) ),
        'new_item' 			 => sprintf( esc_html__( 'New %s', 'xstore-core' ), esc_html__( 'Mega menu', 'xstore-core' ) ),
        'all_items' 		 => sprintf( esc_html__( 'All %s', 'xstore-core' ), esc_html__( 'Mega menus', 'xstore-core' ) ),
        'view_item' 		 => sprintf( esc_html__( 'View %s', 'xstore-core' ), esc_html__( 'Mega menus', 'xstore-core' ) ),
        'search_items'  	 => sprintf( esc_html__( 'Search %s', 'xstore-core' ), esc_html__( 'Mega menus', 'xstore-core' ) ),
        'not_found' 		 => sprintf( esc_html__( 'No %s Found', 'xstore-core' ), esc_html__( 'Mega menus', 'xstore-core' ) ),
        'not_found_in_trash' => sprintf( esc_html__( 'No %s Found In Trash', 'xstore-core' ), esc_html__( 'Mega menus', 'xstore-core' ) ),
        'parent_item_colon'  => '',
        'menu_name' 		 => esc_html__( 'Mega Menus', 'xstore-core' ),
        'public' 			 => true,
        'publicly_queryable' => true,
        'show_ui' 			 => true,
        'show_in_menu' 		 => true,
        'query_var'          => true,
        'rewrite'            => array( 'slug' => 'etheme_mega_menus' ),
 ...
 *	Slides Post Type
 */
add_filter( 'etc/add/post/args', 'etc_add_posttype_slides_args' );
function etc_add_posttype_slides_args( $args ) {
    ...
    $args[] = array(
        'register_name'      => 'etheme_slides',
        'name'          	 => esc_html_x( 'Slides', 'post type general name', 'xstore-core' ),
        'singular_name' 	 => esc_html_x( 'Slide', 'post type singular name', 'xstore-core' ),
        'add_new'       	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Slide', 'xstore-core' ) ),
        'add_new_item'  	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Slide', 'xstore-core' ) ),
        'edit_item' 		 => sprintf( esc_html__( 'Edit %s', 'xstore-core' ),esc_html__( 'Slide', 'xstore-core' ) ),
        'new_item' 			 => sprintf( esc_html__( 'New %s', 'xstore-core' ), esc_html__( 'Slide', 'xstore-core' ) ),
        'all_items' 		 => sprintf( esc_html__( 'All %s', 'xstore-core' ), esc_html__( 'Slides', 'xstore-core' ) ),
        'view_item' 		 => sprintf( esc_html__( 'View %s', 'xstore-core' ), esc_html__( 'Slides', 'xstore-core' ) ),
        'search_items'  	 => sprintf( esc_html__( 'Search %s', 'xstore-core' ), esc_html__( 'Slides', 'xstore-core' ) ),
        'not_found' 		 => sprintf( esc_html__( 'No %s Found', 'xstore-core' ), esc_html__( 'Slides', 'xstore-core' ) ),
        'not_found_in_trash' => sprintf( esc_html__( 'No %s Found In Trash', 'xstore-core' ), esc_html__( 'Slides', 'xstore-core' ) ),
        'parent_item_colon'  => '',
        'menu_name' 		 => esc_html__( 'Slides', 'xstore-core' ),
        'public' 			 => true,
        'publicly_queryable' => true,
        'show_ui' 			 => true,
        'show_in_menu' 		 => true,
        'query_var'          => true,
        'rewrite'            => array( 'slug' => 'etheme_slides' ),
        'capability_type'    => 'post',
        'has_archive'        => false,
        'hierarchical'       => false,
        'description' => 'Custom description zone',
...
function etc_add_posttype_static_blocks_args( $args ) {
    ...
    $args[] = array(
        ...
        'add_new'       	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Static Block', 'xstore-core' ) ),
        'add_new_item'  	 => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Static Block', 'xstore-core' ) ),
        'edit_item' 		 => sprintf( esc_html__( 'Edit %s', 'xstore-core' ),esc_html__( 'Static Block', 'xstore-core' ) ),
        'new_item' 			 => sprintf( esc_html__( 'New %s', 'xstore-core' ), esc_html__( 'Static Block', 'xstore-core' ) ),
        ...
        'search_items'  	 => sprintf( esc_html__( 'Search %s', 'xstore-core' ), esc_html__( 'Static Block', 'xstore-core' ) ),
...
function etc_add_posttype_portfolio_args( $args ) {
	...
	$args[] = array(
		...
		'add_new'            => esc_html__( 'Add New Project', 'xstore-core' ),
...
function etc_add_posttype_testimonial_args( $args ) {
	...
	$args[] = array(
		...
		'add_new'            => sprintf( esc_html__( 'Add New %s', 'xstore-core' ), esc_html__( 'Testimonial', 'xstore-core' ) ),
