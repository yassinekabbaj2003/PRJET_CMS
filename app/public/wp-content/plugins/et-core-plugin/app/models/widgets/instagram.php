...
class Instagram extends Widgets {
    ...
    function widget( $args, $instance ) {
        ...
        // meta args
	    $show_likes = ( !isset( $instance['like_count'] ) ) ? true : $instance['like_count'];
	    $show_comments = ( !isset( $instance['comments_count'] ) ) ? true : $instance['comments_count'];
                                ...
                                if ( $this->API_type == 'old' || $this->force_tag ) {
                                    ...
                                    if ( $this->account_type == 'PERSONAL' ) {
                                        ...
                                        printf(
	                                        ...
	                                        $comments,
                                            isset($item['album_count']) ? $item['album_count'] . ' ' . _nx( 'item', 'items', $item['album_count'], 'instagram album count text', 'xstore-core' ) : '',
                                            (isset($item['media_type'])) ? esc_url( strtolower( $item['media_type'] ) ) : ''
                                        );
                                    }
