...
class Customizer extends Base_Model {
	...
	function _customizer_field(){
        ...
        /**
         * Load customize-general-seo options.
         *
         * @since 5.0.3
         */
        require_once( ET_CORE_DIR . 'app/models/customizer/theme-options/seo/seo.php' );
        ...
        /**
         * Load customize-xstore-waitlist options.
         *
         * @since 5.1.9
         */
        require_once( ET_CORE_DIR . 'app/models/customizer/theme-options/waitlist/global.php' );
