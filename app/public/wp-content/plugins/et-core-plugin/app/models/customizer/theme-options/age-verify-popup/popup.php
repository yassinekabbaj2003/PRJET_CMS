...
add_filter( 'et/customizer/add/sections', function ( $sections ) {
	...
	$args = array(
		'age_verify_popup' => array(
            ...
            'description' => esc_html__('Our Age Verify Popup is a customizable, easy-to-use tool that pops up on your website and requires users to verify their age before accessing your content. This popup is ideal for websites that feature alcohol, tobacco, or other age-restricted products or services.', 'xstore-core'),
			'icon'       => 'dashicons-lock',
			'priority'   => 7,
			'type'       => 'kirki-lazy',
			'dependency' => array()
...
add_filter( 'et/customizer/add/fields/age_verify_popup', function ( $fields ) use ( $separators, $strings, $choices, $sep_style ) {
...
//	);
	...
	$args = array(
		...
		'age_verify_popup_switcher'          => array(
            ...
            'tooltip' => esc_html__('With this option, you can easily enable a popup that asks visitors to verify their age before accessing your website or purchasing age-restricted products. This feature ensures compliance with age verification laws and protects your business from legal issues.', 'xstore-core'),
...
//			)
		...
		'age_verify_popup_switcher_dev_mode'          => array(
			...
			'tooltip' => esc_html__('If you need some time to test your age verification popup, use developer mode. Note: The popup will be displayed on each page load in developer mode.', 'xstore-core'),
			'section'  => 'age_verify_popup',
			'default'  => '0',
		...
		'age_verify_popup_agree_button_text' => array(
            ...
            'tooltip' => esc_html__( 'You can customize the text on your agree button.', 'xstore-core' ),
			'section'         => 'age_verify_popup',
		...
		'age_verify_popup_deny_button_text' => array(
            ...
            'tooltip' => esc_html__( 'You can customize the text on your deny button.', 'xstore-core' ),
			'section'         => 'age_verify_popup',
		...
		'age_verify_popup_deny_button_redirect'        => array(
			...
			'tooltip'     => esc_html__( 'If the customer clicks the "deny" button, enter a link to redirect them, or leave it empty to open the error content.', 'xstore-core' ),
			'section'         => 'age_verify_popup',
			'default'         => '',
			'active_callback' => array(
				array(
...
//			'label'           => sprintf( esc_html__( 'Choose %1s created with WPBakery builder', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
...
//		),
		...
		'age_verify_popup_error_content_separator'     => array(
			...
			'section'         => 'age_verify_popup',
			'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-lock"></span> <span style="padding-inline-start: 3px;">' . __( 'Error content settings' ) . '</span></div>',
			'active_callback' => array(
				array(
					'setting'  => 'age_verify_popup_switcher',
					'operator' => '!=',
		...
		'age_verify_popup_error_title'                 => array(
			...
			'label'           => esc_html__( 'Error title text', 'xstore-core' ),
            'tooltip'   => esc_html__('Customize the text on your title.', 'xstore-core'),
			'section'         => 'age_verify_popup',
		...
		'age_verify_popup_content_width_height'        => array(
            ...
            'tooltip'   => esc_html__( 'Choose which dimensions should be applied for the age verify popup. Select "Custom" to configure the custom dimensions in the form below.', 'xstore-core' ),
			'section'         => 'age_verify_popup',
			'default'         => 'auto',
			'multiple'        => 1,
			'choices'         => array(
		...
		'age_verify_popup_content_width_height_custom' => array(
            ...
            'tooltip'   => esc_html__( 'Configure the dimensions for the age verify popup.', 'xstore-core' ),
			'section'         => 'age_verify_popup',
			'default'         => array(
				'width'  => '550px',
				'height' => '250px',
