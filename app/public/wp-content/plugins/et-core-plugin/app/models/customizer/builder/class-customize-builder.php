...
//            $wp_customize->remove_panel( 'woocommerce');
	...
	public function et_ajax_get_presets(){
		...
		$file = sanitize_file_name($this->post['preset'] . '.json');

		if ( isset( $this->post['header-for-version'] ) ) {
			$file = sanitize_file_name($this->post['preset'] . '.options.json');
			$url  = ET_CORE_DIR . 'app/models/customizer/builder/headers/' . $file;
		} else {
			$url  = ET_CORE_DIR . 'app/models/customizer/builder/presets/' . sanitize_file_name($file);
		}
	...
	public function et_multiple_headers(){
		...
		if ( count( $condition ) ) {
			...
			if ( isset( $headers[$condition['header']] ) ) {
				...
				wp_localize_script( 'etheme', 'etMultiple', array( 'Header'=>$condition['header'] ) );
				// Enqueue specific styles
				wp_enqueue_style(
		...
		switch ( $this->post['type'] ) {
			case 'add':
				...
				if ( $this->post['builder'] == 'header' ) {
					...
					if ( isset($this->post['options']['button_fonts_et-desktop']) )
					...
					// Fonts options
					if ( isset($this->post['options']['single_product_button_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_breadcrumbs_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_breadcrumbs_return_to_previous_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_breadcrumbs_product_title_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_add_to_cart_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_tabs_navigation_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['product_title_fonts_et-desktop']) )
						$headers[$id]['options']['product_title_fonts_et-desktop'] = wp_unslash( $this->post['options']['product_title_fonts_et-desktop'] );
					if ( isset($this->post['options']['single_product_widget_area_1_title_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['request_quote_button_fonts_et-desktop']) )
					...
					if ( isset($this->post['options']['request_quote_popup_content_et-desktop']) )
			...
			case 'save':
				...
				if ( $this->post['builder'] == 'header' ) {
					...
					if ( isset( $headers[ $this->post['header'] ]['options']['cart_footer_content_et-desktop'] ) && isset( $this->post['options']['cart_footer_content_et-desktop'] ) ) {
					...
					if ( $this->post['options']['header_vertical_menu_content_fonts_et-desktop'] )
					...
					if ( $this->post['options']['secondary_title_fonts_et-desktop'] )
					...
					if ( $this->post['options']['mobile_menu_content_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_breadcrumbs_fonts_etproduct_breadcrumbs_fonts_et-desktop']) && $this->post['options']['product_breadcrumbs_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_breadcrumbs_return_to_previous_fonts_et-desktop']) && $this->post['options']['product_breadcrumbs_return_to_previous_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_breadcrumbs_product_title_fonts_et-desktop']) && $this->post['options']['product_breadcrumbs_product_title_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_add_to_cart_fonts_et-desktop']) && $this->post['options']['product_add_to_cart_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_tabs_navigation_fonts_et-desktop']) && $this->post['options']['product_tabs_navigation_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['product_title_fonts_et-desktop']) && $this->post['options']['product_title_fonts_et-desktop'] )
					...
					if ( isset($this->post['options']['single_product_widget_area_1_title_fonts_et-desktop']) && $this->post['options']['single_product_widget_area_1_title_fonts_et-desktop'] )
					...
					if ( isset( $this->post['options']['request_quote_button_fonts_et-desktop']) && $this->post['options']['request_quote_button_fonts_et-desktop'] )
