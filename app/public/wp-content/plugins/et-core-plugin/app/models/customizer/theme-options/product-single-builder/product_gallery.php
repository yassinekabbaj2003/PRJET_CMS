...
add_filter( 'et/customizer/add/fields/product_gallery', function ( $fields ) use ( $separators, $strings, $choices, $box_models ) {
	...
	$args = array(
		...
		'product_gallery_type_et-desktop'       => array(
            ...
            'tooltip'  => esc_html__( 'With this option, you can choose the type of gallery displayed on your individual product pages. Each gallery has its own beauty and unique design, so give each of them a try and see the difference for yourself.', 'xstore-core' ),
			'section'  => 'product_gallery',
		...
		'product_gallery_zoom_et-desktop'       => array(
            ...
            'tooltip'         => esc_html__('Increase your sales by providing customers with a clear view of your products. Enable the option to add a zoom feature to product images so that customers can quickly and easily zoom in on the product image.', 'xstore-core'),
			'section'         => 'product_gallery',
			'default'         => 1,
		...
		'product_gallery_lightbox_et-desktop'   => array(
            ...
            'tooltip'         => esc_html__('Lightbox is a feature that displays your image or images against a dark background, illuminating them, similar to a real-life photo lightbox. Increase sales and conversions by adding a product gallery lightbox to your single product gallery images. To add the lightbox feature to your single product pages, simply set this option to active.', 'xstore-core'),
			'section'         => 'product_gallery',
			'default'         => 0,
			'active_callback' => array(
				array(
		...
		'product_gallery_thumbnails_et-desktop' => array(
            ...
            'tooltip' => esc_html__('If you would like to display your gallery thumbnails in a slider format, you should enable this feature. Note: if you would like to keep the thumbnails in a grid mode, you should keep it inactive.', 'xstore-core'),
			'section'         => 'product_gallery',
			'default'         => 1,
			'active_callback' => array(
				array(
		...
		'product_video_position'                           => array(
			...
			'label'       => esc_html__( 'Video position', 'xstore-core' ),
			'tooltip' => esc_html__( 'Choose the position of the product video in the product gallery. Note: the position of the video will be applied to products which have at least one video added in their settings.', 'xstore-core' ),
			'section'     => 'product_gallery',
			'default'     => 'last',
			'choices'     => array(
		...
		'go_to_section_product_sale_label'                 => array(
			...
			'section'  => 'product_gallery',
			'default'  => '<span class="et_edit" data-parent="product_sale_label" data-section="product_sale_label_content_separator" style="padding: 6px 7px; border-radius: 5px; background: var(--customizer-dark-color, #222); color: var(--customizer-white-color, #fff); font-size: calc(var(--customizer-ui-content-zoom, 1) * 12px); text-align: center;">' . esc_html__( 'Sale label', 'xstore-core' ) . '</span>',
			'priority' => 6,
		),
		...
		'go_to_section_woocommerce_product_images'         => array(
			...
			'section'  => 'product_gallery',
			'default'  => '<span class="et_edit" data-parent="woocommerce_product_images" data-section="woocommerce_single_image_width" style="padding: 6px 7px; border-radius: 5px; background: var(--customizer-dark-color, #222); color: var(--customizer-white-color, #fff); font-size: calc(var(--customizer-ui-content-zoom, 1) * 12px); text-align: center;">' . esc_html__( 'Image sizes', 'xstore-core' ) . '</span>',
			'priority' => 7,
		),
		...
		'go_to_section_variations-gallery'                 => array(
			...
			'section'  => 'product_gallery',
			'default'  => '<span class="et_edit" data-parent="variations-gallery" data-section="enable_variation_gallery" style="padding: 6px 7px; border-radius: 5px; background: var(--customizer-dark-color, #222); color: var(--customizer-white-color, #fff); font-size: calc(var(--customizer-ui-content-zoom, 1) * 12px); text-align: center;">' . esc_html__( 'Variations gallery', 'xstore-core' ) . '</span>',
			'priority' => 8,
		),
		...
		'product_gallery_width_et-desktop'                 => array(
            ...
            'tooltip' => esc_html__( 'This regulates the width of the product gallery.', 'xstore-core' ),
			'section'  => 'product_gallery',
			'default'  => 100,
			'choices'  => array(
				'min'  => '0',
		...
		'product_thumbnails_columns_et-desktop'            => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of items displayed in the thumbnail gallery.', 'xstore-core' ),
			'section'         => 'product_gallery',
			'default'         => 4,
			'choices'         => array(
				'min'  => '3',
		...
		'product_gallery_spacing_et-desktop'               => array(
            ...
            'tooltip'         => esc_html__('With this option, you can set the amount of space between items displayed in the product gallery.', 'xstore-core'),
			'section'         => 'product_gallery',
			'default'         => 10,
			'choices'         => array(
				'min'  => '0',
		...
		'product_gallery_arrow_size'                       => array(
            ...
            'tooltip'         => esc_html__('This controls the size of the arrows for the product gallery slider.', 'xstore-core'),
			'section'         => 'product_gallery',
			'default'         => 50,
			'choices'         => array(
				'min'  => '20',
		...
		'product_gallery_lightbox_background_color_custom' => array(
            ...
            'tooltip'         => esc_html__( 'Choose the background color for the lightbox of the product images.', 'xstore-core' ),
			'section'         => 'product_gallery',
			'choices'         => array(
				'alpha' => true,
			),
