...
<?php 
    ...
    if ( $element_options['not_account'] && ($element_options['account_off_canvas'] || $element_options['is_customize_preview']) ) {
    ...
    if ( $element_options['not_account'] && ($element_options['etheme_mini_account_content'] || $element_options['is_customize_preview']) ) {
	    if ( function_exists('etheme_enqueue_style')) {
