...
add_filter( 'et/customizer/add/fields/product_price', function ( $fields ) use ( $separators, $strings, $choices ) {
	...
	$args = array(
		...
		'product_price_color_custom_et-desktop'      => array(
            ...
            'tooltip' => esc_html__( 'Choose the text color for the price.', 'xstore-core' ),
			'section'   => 'product_price',
			'default'   => '#555555',
			'choices'   => array(
				'alpha' => true
		...
		'product_price_sale_color_custom_et-desktop' => array(
            ...
            'tooltip' => esc_html__( 'Choose the text color for the crossed out original price.', 'xstore-core' ),
			'section'   => 'product_price',
			'default'   => '#c62828',
			'choices'   => array(
				'alpha' => true
