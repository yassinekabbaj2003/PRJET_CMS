...
add_filter( 'et/customizer/add/sections', function ( $sections ) {
	...
	$args = array(
		'products_upsell' => array(
			...
			'title'      => esc_html__( 'Up-sell products', 'xstore-core' ),
...
add_filter( 'et/customizer/add/fields/products_upsell', function ( $fields ) use ( $separators, $product_settings, $strings, $sep_style, $choices ) {
	$args = array();
	...
	$args = array(
		...
		'products_upsell_type_et-desktop'                  => array(
            ...
            'tooltip'  => esc_html__('Choose the design type for the up-sell products.', 'xstore-core'),
			'section'  => 'products_upsell',
			'default'  => 'slider',
			'multiple' => 1,
		...
		'products_upsell_per_view_et-desktop'              => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of products displayed for up-sell products.', 'xstore-core' ),
			'section'  => 'products_upsell',
			'default'  => 4,
			'choices'  => array(
				'min'  => '1',
		...
		'products_upsell_per_view_et-mobile'               => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of products displayed for up-sell products carousel.', 'xstore-core' ),
			'section'  => 'products_upsell',
			'default'  => 2,
			'choices'  => array(
				'min'  => '1',
		...
		'products_upsell_limit_et-desktop'                 => array(
            ...
            'tooltip'     => esc_html__( 'Use this option to limit the maximum number of products displayed for up-sell products.', 'xstore-core' ),
			'section'  => 'products_upsell',
			'default'  => 7,
			'choices'  => array(
				'min'  => '1',
        ...
        'products_upsell_out_of_stock_et-desktop'          => array(
            ...
            'tooltip' => esc_html__('Enable this option to hide products that are out of stock in up-sell products.', 'xstore-core'),
            'section'  => 'products_upsell',
            'default'  => 0,
        ),
        ...
        'products_upsells_sale_label_et-desktop'           => array(
            ...
            'tooltip' => esc_html__('Enable this option to hide "Sale" label for products in up-sell products.', 'xstore-core'),
            'section'  => 'products_upsell',
            'default'  => 0,
        ),

        'products_upsell_title_style_separator' => array(
            'name' => 'products_upsell_title_style_separator',
            'type' => 'custom',
            'settings' => 'products_upsell_title_style_separator',
            'section' => 'products_upsell',
