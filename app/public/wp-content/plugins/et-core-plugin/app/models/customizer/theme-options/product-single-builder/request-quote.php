...
add_filter( 'et/customizer/add/fields/single-request-quote', function ( $fields ) use ( $separators, $sep_style, $strings, $choices, $box_models ) {
	$args = array();
...
// 'name'		  => 'request_quote_popup_content_alignment_et-desktop',
		...
		'request_quote_popup_content_width_height_et-desktop'        => array(
            ...
            'tooltip'   => esc_html__( 'Choose which dimensions should be applied for the "Request a quote" popup. Select "Custom" to configure the custom dimensions in the form below.', 'xstore-core' ),
			'section'   => 'single-request-quote',
			'default'   => 'auto',
			'multiple'  => 1,
			'choices'   => array(
		...
		'request_quote_popup_content_width_height_custom_et-desktop' => array(
            ...
            'tooltip'   => esc_html__( 'Configure the dimensions for the "Request a quote" popup.', 'xstore-core' ),
			'section'   => 'single-request-quote',
			'default'   => array(
				'width'  => '550px',
				'height' => '250px',
