 ...
 * @version 1.0.1
 * @since   2.3.7
 * @last changes in 4.3.9 - added Compare options
 */
...
//			),
        ...
        'compare_content_type_et-desktop'                      => array(
            ...
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-compare content. There are three options available for you: Dropdown, Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ),
            'section'         => 'compare',
            'default'         => 'dropdown',
            'multiple'        => 1,
            'choices'         => array(
        ...
        'compare_content_type_et-mobile'                       => array(
            ...
            'label'           => esc_html__( 'Content type', 'xstore-core' ),
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-compare content. There are few options available for you: Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ),
            'section'         => 'compare',
            'default'         => 'off_canvas',
            'multiple'        => 1,
            'choices'         => array(
        ...
        'mini-compare-items-count'                             => array(
            ...
            'label'           => esc_html__( 'Mini-compare products amount', 'xstore-core' ),
...
//            'label'           => esc_html__( 'WCAG compare quantity Color (active)', 'xstore-core' ),
        ...
        'compare_content_dropdown_separator'            => array(
            ...
            'section'  => 'compare',
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-editor-outdent"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Mini-compare Dropdown', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
            'active_callback' => array(
                array(
                    'setting'  => 'xstore_compare',
