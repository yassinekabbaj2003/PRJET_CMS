...
add_filter( 'et/customizer/add/fields/mobile_menu', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $menu_settings, $box_models ) {
	...
	$args = array(
		...
		'mobile_menu_type_et-desktop'                        => array(
            ...
            'tooltip'  => esc_html__( 'Choose the type of content for the mobile menu. There are three options available for you: Off-Canvas Left, Off-Canvas Right, and popup.', 'xstore-core' ),
			'section'  => 'mobile_menu',
		...
		'mobile_menu_elements_separator'                     => array(
			...
			'section'  => 'mobile_menu',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-list-view"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Elements', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
        ...
        'mobile_menu_term'                                   => array(
            ...
            'label'           => $menu_settings['strings']['label']['select_menu'],
        ...
        'mobile_menu_one_page'                               => array(
            ...
            'tooltip'     => esc_html__( 'Enable when your menu is working only for one page by anchors', 'xstore-core' ),
            'section'         => 'mobile_menu',
            'default'         => '0',
            'active_callback' => array(
                array(
        ...
        'mobile_menu_item_click_et-desktop'                  => array(
            ...
            'tooltip'     => esc_html__( 'Only open the drop-down menu when the arrow is clicked. Please, check on real devices.', 'xstore-core' ),
            'section'         => 'mobile_menu',
            'default'         => '0',
            'active_callback' => array(
                array(
		...
		'mobile_menu_2'                                      => array(
			...
			'label'           => esc_html__( 'Additional tab content', 'xstore-core' ),
			'tooltip'         => esc_html__( 'Choose the content to be displayed in an additional tab.', 'xstore-core' ),
			'section'         => 'mobile_menu',
			'default'         => 'none',
			'choices'         => array(
				'none'       => esc_html__( 'Nothing', 'xstore-core' ),
		...
		'mobile_menu_2_categories_hide_empty'                => array(
            ...
            'tooltip'         => esc_html__( 'Prevent displaying product categories in the list that do not have any products assigned.', 'xstore-core' ),
			'section'         => 'mobile_menu',
			'default'         => '0',
			'active_callback' => array(
				array(
		...
		'mobile_menu_2_categories_primary'                   => array(
			...
			'label'           => esc_html__( 'Categories prioritized', 'xstore-core' ),
            'tooltip'         => esc_html__( 'Move the "Categories" tab to the first position to display it first in the mobile menu content.', 'xstore-core' ),
			'section'         => 'mobile_menu',
			'default'         => '0',
			'active_callback' => array(
				array(
		...
		'mobile_menu_2_term'                                 => array(
            ...
            'label'           => $menu_settings['strings']['label']['select_menu_extra'],
			'tooltip'         => $menu_settings['strings']['description']['select_menu'],
			'section'         => 'mobile_menu',
			'choices'         => $menus,
			'active_callback' => array(
		...
		'mobile_menu_tab_2_text'                             => array(
			...
			'label'           => esc_html__( 'Additional tab title', 'xstore-core' ),
            'tooltip'   => sprintf(esc_html__('Customize the text on your additional tab, with the default being "%s".', 'xstore-core'), esc_html__( 'Categories', 'xstore-core' )),
			'section'         => 'mobile_menu',
		...
		'mobile_menu_logo_type_et-desktop'                   => array(
			...
			'tooltip'     => sprintf( esc_html__( 'Choose the logo you want to use from the %s main %s or %s sticky %s header settings.', 'xstore-core' ),
				'<span class="et_edit" data-parent="logo" data-section="logo_content_separator" data-option="#customize-control-logo_img" style="text-decoration: underline;">', '</span>',
				'<span class="et_edit" data-parent="headers_sticky" data-section="header_sticky_content_separator" data-option="#customize-control-headers_sticky_logo_img" style="text-decoration: underline;">', '</span>' ),
			'section'         => 'mobile_menu',
			'default'         => 'simple',
			'multiple'        => 1,
			'choices'         => array(
		...
		'mobile_menu_logo_width_et-desktop'                  => array(
            ...
            'tooltip' => sprintf(esc_html__('This setting controls the width of the logo image in pixels, with the default being %s.', 'xstore-core'), '200px'),
			'section'         => 'mobile_menu',
			'default'         => 200,
			'choices'         => array(
				'min'  => '10',
		...
		'mobile_menu_style_separator'                        => array(
			...
			'section'  => 'mobile_menu',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-customizer"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Icon styles', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'       => esc_html__( 'Border color of the menu icon', 'xstore-core' ),
		...
		'mobile_menu_dropdown_separator'                     => array(
			...
			'section'         => 'mobile_menu',
			'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-editor-outdent"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Off-Canvas content', 'xstore-core' ) . '</span></div>',
			'priority'        => 10,
			'active_callback' => array(
				array(
		...
		'mobile_menu_popup_separator'                        => array(
			...
			'section'         => 'mobile_menu',
			'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-external"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Popup content', 'xstore-core' ) . '</span></div>',
			'priority'        => 10,
			'active_callback' => array(
				array(
					'setting'  => 'mobile_menu_type_et-desktop',
		...
		'mobile_menu_items_space_popup_et-desktop'           => array(
            ...
            'tooltip'         => esc_html__('Using this option, you can set the spacing value for elements shown in mobile menu content area.', 'xstore-core'),
			'section'         => 'mobile_menu',
			'default'         => 10,
			'choices'         => array(
				'min'  => '0',
		...
		'mobile_menu_overlay_et-desktop'                     => array(
			...
			'tooltip'     => esc_html__( 'Choose the background color for the popup overlay.', 'xstore-core' ),
			'type'            => 'color',
			'section'         => 'mobile_menu',
...
//			'label'           => esc_html__( 'Popup content WCAG Color', 'xstore-core' ),
		...
		'mobile_menu_max_height_et-desktop'                  => array(
            ...
            'tooltip'         => esc_html__( 'This controls the maximum height of the mobile menu popup content.', 'xstore-core' ),
			'section'         => 'mobile_menu',
			'default'         => 70,
			'choices'         => array(
				'min'  => '0',
