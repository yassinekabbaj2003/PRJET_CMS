...
add_filter( 'et/customizer/add/sections', function ( $sections ) {
    ...
    $args = array(
        'search' => array(
            ...
            'description' => esc_html__('The Search Element enables you to customize the search completely, giving you the option to change the icon, button color, background color, search box text color, and many other features.  This way, you can ensure that the search blends seamlessly with your website\'s overall design and style.', 'xstore-core'),
...
add_filter( 'et/customizer/add/fields/search', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $sidebars_with_inherit, $box_models ) {
    ...
    $args = array(
        ...
        'search_type_et-desktop'             => array(
            ...
            'tooltip'  => $strings['description']['type'],
            'section'  => 'search',
            'default'  => 'input',
            'multiple' => 1,
            'choices'  => array(
        ...
        'search_ajax_et-desktop'             => array(
            ...
            'tooltip'   => esc_html__('Enable this option if you want the search results to be displayed directly below the search form without needing to go to another page.', 'xstore-core') . '<br/>' .
                sprintf(esc_html__('Tip: you may enable option %1s to save most popular search results in cache', 'xstore-core'), '<span class="et_edit" data-parent="general-optimization" data-section="ajax_search_cache" style="text-decoration: underline;">' . esc_html__('Ajax search results cache', 'xstore-core') . '</span>'),
            'section'  => 'search',
            'default'  => '1',
        ),
        ...
        'search_ajax_history_et-desktop'             => array(
            ...
            'tooltip' => esc_html__( 'If you would like to save user search requests history, this option should be used. It will add an additional cookie to the customer\'s browser with the following parameters: name: "et_search_history", purpose: "Store user search requests", expiry: "5 days by default".', 'xstore-core' ) . '<br/>'.
        ...
        'search_ajax_history_time-desktop' => array(
            ...
            'label'           => esc_html__( 'Cookies lifespan', 'xstore-core' ),
            'tooltip'     => esc_html__( 'Days limit while customer\'s search history is stored.', 'xstore-core' ) . '<br/>' .
                esc_html__('Note: Please remember to include this in the security policy (GDPR).', 'xstore-core'),
            'section'         => 'search',
            'default'         => 5,
            'choices'         => array(
        ...
        'search_ajax_history_title_et-desktop' => array(
            ...
            'label'     => esc_html__( 'History title', 'xstore-core' ),
            'tooltip'   => esc_html__('Customize the heading text of the Ajax history list.', 'xstore-core'),
            'section'   => 'search',
...
//		),
        ...
        'search_ajax_history_length-desktop' => array(
            ...
            'label'           => esc_html__( 'History requests limit', 'xstore-core' ),
            'tooltip'         => esc_html__( 'Set the maximum number of items to be displayed in the Ajax history list.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 7,
            'choices'         => array(
                'min'  => '1',
        ...
        'search_ajax_min_symbols_et-desktop' => array(
            ...
            'label'           => esc_html__( 'Do Ajax Search after X characters', 'xstore-core' ),
            'tooltip' => esc_html__('Perform an Ajax search after entering at least X characters.', 'xstore-core'),
            'section'         => 'search',
            'default'         => 3,
            'choices'         => array(
                'min'  => '2',
        ...
        'search_ajax_posts_per_page'         => array(
            ...
            'label'           => esc_html__( 'Results limit', 'xstore-core' ),
            'tooltip'     => esc_html__( 'Use this option to limit the maximum number of results displayed in the list. This is useful if you have thousands of posts/products and want to make your Ajax search faster. The default value is 100. Note: use -1 to display an unlimited number of results.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 100,
            'choices'         => array(
                'min'  => '-1',
        ...
        'search_placeholder_et-desktop'      => array(
            ...
            'tooltip'   => esc_html__('Customize the placeholder text of the input.', 'xstore-core'),
            'section'   => 'search',
        ...
        'search_tags_et-desktop'             => array(
            ...
            'tooltip'     => esc_html__( 'Write your most popular search terms, separated by commas, to enable customers to search for results with one click.', 'xstore-core' ),
            'section'         => 'search',
        ...
        'search_extra_content_et-desktop'                 => array(
            ...
            'label'           => esc_html__( 'Additional content', 'xstore-core' ),
            'tooltip'         => esc_html__('Choose what would you also like to display in the search results popup window.', 'xstore-core'),
            'section'         => 'search',
            'priority'        => 10,
            'multiple'        => 1,
            'choices'         => array(
        ...
        'search_categories_et-desktop'                    => array(
            ...
            'tooltip' => esc_html__('Select which product categories to display in the additional search content area.', 'xstore-core'),
            'section'         => 'search',
        ...
        'search_staticblock'                              => array(
            ...
            'label'           => sprintf( esc_html__( 'Choose a %1s to search for additional content.', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
        ...
        'search_results_content_separator'                => array(
            ...
            'section'  => 'search',
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Search results', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
        ),
        ...
        'search_results_content_et-desktop'               => array(
            ...
            'type'        => 'sortable',
            'label'       => esc_html__( 'Search by', 'xstore-core' ),
            'tooltip' => esc_html__( 'Revamp your results in search with ease by turning on/off the essential elements you need. Our drag and drop feature lets you rearrange them in a snap.', 'xstore-core' ),
            'section'     => 'search',
        ...
        'search_by_sku_et-desktop'                        => array(
            ...
            'tooltip'         => esc_html__('Enable this option, if you want to give customers the ability to search for products by their SKU.', 'xstore-core'),
            'section'         => 'search',
            'default'         => 1,
            'active_callback' => array(
                array(
        ...
        'search_category_et-desktop'                      => array(
            ...
            'tooltip' => esc_html__('If you want to give customers the ability to search by specific product categories, enable this option and they will be able to select needed one from the categories dropdown.', 'xstore-core'),
            'section'         => 'search',
            'default'         => '1',
            'active_callback' => array(
                array(
        ...
        'search_category_select_color_scheme_et-desktop'  => array(
            ...
            'label'           => esc_html__( 'Categories color scheme', 'xstore-core' ),
            'tooltip' => esc_html__( 'Choose the color scheme for the product categories dropdown.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 'dark',
            'multiple'        => 1,
            'choices'         => array(
        ...
        'search_all_categories_text_et-desktop'           => array(
            ...
            'tooltip'   => esc_html__('Customize the text on "All categories" text.', 'xstore-core'),
            'section'         => 'search',
        ...
        'search_product_variation_et-desktop'             => array(
            ...
            'tooltip'         => esc_html__('Enable this option, if you want to give customers the ability to search for product variations.', 'xstore-core'),
            'section'         => 'search',
            'default'         => 0,
            'active_callback' => array(
                array(
        ...
        'search_product_hide_variation_parent_et-desktop' => array(
            ...
            'label'           => esc_html__( 'Hide variable products', 'xstore-core' ),
            'tooltip'         => esc_html__('Selecting this option will hide variable products from search results, but will display their variations instead.', 'xstore-core'),
            'section'         => 'search',
            'default'         => 0,
            'active_callback' => array(
                array(
        ...
        'search_category_fancy_select_et-desktop'         => array(
            ...
            'label'           => esc_html__( 'Fancy select', 'xstore-core' ),
            'tooltip'         => esc_html__('Enable this option to replace the default browser product categories select with a nicely-styled and customizable one.', 'xstore-core'),
            'section'         => 'search',
            'default'         => '0',
            'active_callback' => array(
                array(
        ...
        'search_ajax_with_tabs_et-desktop'                => array(
            ...
            'tooltip' => esc_html__( 'Search results will be divided into different tabs according to their post type.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => '0',
            'active_callback' => array(
                array(
        ...
        // content separator
        'search_results_page_content_separator'                => array(
            'name'     => 'search_results_page_content_separator',
            'type'     => 'custom',
            'settings' => 'search_results_page_content_separator',
            'section'  => 'search',
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Search results page', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
        ),
        ...
        'search_page_sidebar_et-desktop'                  => array(
            ...
            'tooltip' => esc_html__( 'Choose the position of the sidebar for the search results page.', 'xstore-core' ),
            'section'     => 'search',
            'default'     => 'without',
        ...
        'search_page_custom_area_position_et-desktop'     => array(
            ...
            'label'       => esc_html__( 'Custom area position', 'xstore-core' ),
            'tooltip' => esc_html__( 'Choose the position of the custom area for the search results page.', 'xstore-core' ),
            'section'     => 'search',
            'default'     => 'none',
            'choices'     => array(
        ...
        'search_icon_zoom_et-desktop'                     => array(
            ...
            'tooltip'     => $strings['description']['icon_size_proportion'] . '<br/>' .
                esc_html__( 'Note: It works nly for search type icon', 'xstore-core' ),
            'section'     => 'search',
            'default'     => 1,
            'choices'     => array(
                'min'  => '.7',
        ...
        'search_width_et-desktop'                         => array(
            ...
            'tooltip' => esc_html__( 'This controls the width of the search form.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 100,
            'choices'         => array(
                'min'  => '10',
        ...
        'search_height_et-desktop'                        => array(
            ...
            'tooltip' => esc_html__( 'This controls the height of the search form.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 40,
            'choices'         => array(
                'min'  => '10',
        ...
        'search_input_separator'         => array(
            ...
            'section'         => 'search',
            'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-editor-removeformatting"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Input boxes', 'xstore-core' ) . '</span></div>',
            'priority'        => 10,
            'active_callback' => array(
                array(
                    'setting'  => 'search_type_et-desktop',
        ...
        'search_icon_separator'                         => array(
            ...
            'section'         => 'search',
            'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-code-standards"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Icon', 'xstore-core' ) . '</span></div>',
            'priority'        => 10,
            'active_callback' => array(
                array(
                    'setting'  => 'search_type_et-desktop',
        ...
        'search_content_dropdown_separator'             => array(
            ...
            'section'  => 'search',
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-images-alt"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Results Dropdown', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
//			'active_callback' => array(
//				array(
//					'setting'  => 'search_type_et-desktop',
...
//			'label'           => esc_html__( 'Results Dropdown Position', 'xstore-core' ),
            ...
            'tooltip'         => esc_html__( 'Choose the position for the results dropdown content.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 'right',
            'multiple'        => 1,
...
//			'label'           => esc_html__( 'Results Dropdown offset', 'xstore-core' ),
            ...
            'tooltip'         => esc_html__( 'Set the offset position for the results dropdown content.', 'xstore-core' ),
            'section'         => 'search',
            'default'         => 0,
            'choices'         => array(
                'min'  => '-300',
