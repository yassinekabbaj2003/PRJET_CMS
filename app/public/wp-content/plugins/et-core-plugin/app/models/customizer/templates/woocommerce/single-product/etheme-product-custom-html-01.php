 ...
 */
	...
	if ( apply_filters('is_customize_preview', false) ) 
		$element_options['attributes'] = array(
			'data-title="' . esc_html__( 'Single product custom HTML 1', 'xstore-core' ) . '"',
			'data-element="single_product_html_blocks"'
		); 
?>

<div class="et_element single_product-html_block single_product-html_block1" <?php echo implode( ' ', $element_options['attributes'] ); ?>><?php echo html_blocks_callback(array(
