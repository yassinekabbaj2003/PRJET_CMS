...
add_filter( 'et/customizer/add/sections', function ( $sections ) {
	...
	$args = array(
		'html_blocks' => array(
            ...
            'description' => esc_html__('With this option, the possibilities for customizing your website\'s header are virtually limitless! Add your own HTML code to create unique elements such as social media icons, custom navigation menus, and much more. The HTML Block option is perfect for those who want complete control over their website\'s header design.', 'xstore-core'),
...
add_filter( 'et/customizer/add/fields/html_blocks', function ( $fields ) use ( $strings, $choices, $sep_style ) {
	...
	$args = array(
		...
		'html_block1_content_separator' => array(
			...
			'section'  => 'html_blocks',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'HTML Block 1', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'           => sprintf( esc_html__( 'Choose %1s for HTML Block 1', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
		...
		'html_block2_content_separator' => array(
			...
			'section'  => 'html_blocks',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'HTML Block 2', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'           => sprintf( esc_html__( 'Choose %1s for HTML Block 2', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
            'label'           => $strings['label']['choose_static_block'],
            'tooltip'         => $strings['description']['choose_static_block'],
			'section'         => 'html_blocks',
			'default'         => '',
		...
		'html_block3_content_separator' => array(
			...
			'section'  => 'html_blocks',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'HTML Block 3', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'           => sprintf( esc_html__( 'Choose %1s for HTML Block 3', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
            'label'           => $strings['label']['choose_static_block'],
            'tooltip'         => $strings['description']['choose_static_block'],
			'section'         => 'html_blocks',
			'default'         => '',
		...
		'html_block4_content_separator' => array(
			...
			'section'  => 'html_blocks',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'HTML block 4', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'           => sprintf( esc_html__( 'Choose %1s for HTML block 4', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
            'label'           => $strings['label']['choose_static_block'],
            'tooltip'         => $strings['description']['choose_static_block'],
			'section'         => 'html_blocks',
			'default'         => '',
		...
		'html_block5_content_separator' => array(
			...
			'section'  => 'html_blocks',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-settings"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'HTML block 5', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
...
//			'label'           => sprintf( esc_html__( 'Choose %1s for HTML block 5', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
            'label'           => $strings['label']['choose_static_block'],
            'tooltip'         => $strings['description']['choose_static_block'],
			'section'         => 'html_blocks',
			'default'         => '',
