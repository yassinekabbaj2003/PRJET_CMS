...
//			),
        ...
        'cart_total_et-desktop'           => array(
            ...
            'label'     => esc_html__( 'Total price', 'xstore-core' ),
            'tooltip'   => esc_html__( 'Turn on/off to show/hide the total price for this element', 'xstore-core' ),
            'section'   => 'cart',
            'default'   => 1,
            'transport' => 'postMessage',
            'js_vars'   => array(
        ...
        'cart_content_type_et-desktop'    => array(
            ...
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-cart content. There are three options available for you: Dropdown, Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ),
            'section'         => 'cart',
            'default'         => 'dropdown',
            'multiple'        => 1,
            'choices'         => array(
        ...
        'cart_content_type_et-mobile'     => array(
            ...
            'label'           => esc_html__( 'Content type', 'xstore-core' ),
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-cart content. There are few options available for you: Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ),
            'section'         => 'cart',
            'default'         => 'off_canvas',
            'multiple'        => 1,
            'choices'         => array(
        ...
        'mini-cart-items-count'                  => array(
            ...
            'label'           => esc_html__( 'Mini-cart products amount', 'xstore-core' ),
        ...
        'cart_content_quantity_input_et-desktop' => array(
            ...
            'tooltip'         => esc_html__('Turn this option to add quantity input for products in mini-cart content', 'xstore-core'),
            'section'         => 'cart',
            'default'         => 0,
            'transport'       => 'postMessage',
            'partial_refresh' => array(
        ...
        'cart_content_linked_products_et-desktop'                     => array(
            ...
            'tooltip'  => esc_html__('Enable this option to display upsells or cross-sells products based on the items added to the cart.', 'xstore-core'),
            'section'  => 'cart',
            'default'  => '0',
        ),
        ...
        'cart_content_linked_products_type_et-desktop'                => array(
            ...
            'tooltip'  => esc_html__('Choose which type of products to display in the contents of the mini-cart.', 'xstore-core'),
            'section'         => 'cart',
            'default'         => 'upsell',
            'choices'         => array(
...
//			'label'           => esc_html__( 'Show view cart button', 'xstore-core' ),
            'label'           => esc_html__( 'View cart button', 'xstore-core' ),
            'tooltip'  => esc_html__('Enable this option to display the "View Cart" button at the bottom of the contents of the mini-cart.', 'xstore-core'),
            'section'         => 'cart',
            'default'         => 0,
            'transport'       => 'postMessage',
            'partial_refresh' => array(
        ...
        'go_to_section_ajax_added_product_notify_popup_products_type' => array(
            ...
            'section'  => 'cart',
            'default'  => '<span class="et_edit" data-parent="shop-page" data-section="ajax_added_product_notify_popup_products_type" style="padding: 6px 7px; border-radius: 5px; background: var(--customizer-dark-color, #222); color: var(--customizer-white-color, #fff); font-size: calc(var(--customizer-ui-content-zoom, 1) * 12px); text-align: center;">' . esc_html__( 'Added to cart notification', 'xstore-core' ) . '</span>',
        ),
...
//			'label'           => esc_html__( 'Show cart quantity', 'xstore-core' ),
        ...
        'cart_quantity_size_et-desktop'                               => array(
            ...
            'label'           => esc_html__( 'Font size (em)', 'xstore-core' ),
        ...
        'cart_quantity_proportions_et-desktop'                        => array(
            ...
            'label'           => esc_html__( 'Background size (em)', 'xstore-core' ),
...
//            'label'           => esc_html__( 'Cart quantity Background (active)', 'xstore-core' ),
...
//			'label'           => esc_html__( 'WCAG cart quantity Color (active)', 'xstore-core' ),
        ...
        'cart_content_dropdown_separator'                             => array(
            ...
            'section'  => 'cart',
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-editor-outdent"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Mini-cart Dropdown', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
        ),
...
//			'default'  => $separators['advanced'],
            'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-star-filled"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Promo message', 'xstore-core' ) . '</span></div>',
            'priority' => 10,
        ),
