...
add_filter( 'et/customizer/add/fields/cart_off', function ( $fields ) {
	...
	$args = array(
		'cart_off_text' => array(
			...
			'section'  => 'cart_off',
			'default'  => sprintf(esc_html__( 'To use Cart options please install %1s', 'xstore-core' ), '<a href="https://uk.wordpress.org/plugins/woocommerce/" rel="nofollow" target="_blank">' . esc_html__( 'WooCommerce', 'xstore-core' ) . '</a>'),
		)
	);
