...
add_filter( 'et/customizer/add/fields/secondary_menu', function ( $fields ) use ( $separators, $strings, $choices, $menu_settings, $sep_style ) {
	...
	$args = array(
		...
		'secondary_menu_visibility' => array(
			...
			'tooltip' => esc_html__( 'Choose the way to show the all departments.', 'xstore-core' ),
			'section'     => 'secondary_menu',
			'default'     => 'on_hover',
			'choices'     => array(
		...
		'secondary_menu_home' => array(
			...
			'tooltip'     => esc_html__( 'Turn on to keep the all departments opened only for the home page.', 'xstore-core' ),
			'section'         => 'secondary_menu',
			'default'         => '1',
		...
		// 	'tooltip' => esc_html__( 'Turn on to show the semi-transparent dark veil over the content and highlight the menu only.', 'xstore-core' ),
		// 	'section'     => 'secondary_menu',
		// 	'default'     => 1,
		// 	'active_callback' => array(
		// 		array(
		...
		'all_departments_text' => array(
			...
			'tooltip' => esc_html__( 'This text will be displayed instead of the default "All departments" title for the all departments.', 'xstore-core' ),
			'section'     => 'secondary_menu',
		...
		'secondary_menu_more_items_link' => array(
			...
			'tooltip' => esc_html__( 'Turn on to show more items link after count of shown you can set below.', 'xstore-core' ),
			'section'     => 'secondary_menu',
			'default'     => 0,
		),
		...
		'secondary_menu_more_items_link_after' => array(
			...
			'tooltip'     => esc_html__( 'Set limit items to show before "More link" button. Min value - 5.', 'xstore-core' ),
			'section'         => 'secondary_menu',
			'default'         => 10,
			'choices'         => array(
				'min'  => 5,
		...
		'secondary_menu_less_items_link'                     => array(
			...
			'tooltip'     => esc_html__( 'Turn on to show less items link after count of shown you can set above.', 'xstore-core' ),
			'section'         => 'secondary_menu',
			'default'         => 0,
			'active_callback' => array(
				array(
		...
		'secondary_menu_title_style_separator'               => array(
			...
			'section'  => 'secondary_menu',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-customizer"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Title', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
		...
		'secondary_title_fonts_et-desktop'                   => array(
            ...
            'tooltip'   => $strings['description']['fonts'] . ' ' . esc_html__('Note: this setting will change the main title fonts only', 'xstore-core'),
			'section'   => 'secondary_menu',
			'default'   => array(
				'font-family'    => '',
				'variant'        => 'regular',
		...
		'secondary_menu_content_dropdown_separator'             => array(
			...
			'section'  => 'secondary_menu',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-editor-outdent"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Menu Dropdown', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
