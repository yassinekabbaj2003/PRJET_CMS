...
<div class="et_builder-multiple <?php echo $classes[0]; ?> hidden">
	<div class="et_builder-multiples <?php echo $classes[2]; ?>">
		<h3>
            ...
            <a href="https://www.youtube.com/watch?v=BpeXfzNwkOc&amp;feature=youtu.be" target="_blank" style="color: var(--customizer-dark-color, #222);font-size: .7em;">watch the video.</a>
		</h3>
		<div class="et_builder-multiple-content <?php echo $classes[1]; ?>">
			<?php require( ET_CORE_DIR . 'app/models/customizer/builder/template-parts/conditions/multiple-'.sanitize_file_name($builder).'.php' ); ?>
		</div>
	</div>
</div>