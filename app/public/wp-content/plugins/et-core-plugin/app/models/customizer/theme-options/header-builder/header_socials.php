...
add_filter( 'et/customizer/add/fields', function ( $fields ) use ( $separators, $strings, $choices, $icons ) {
	...
	$args = array(
		...
		'header_socials_package_et-desktop' => array(
            ...
            'tooltip'     => esc_html__( 'Easily revamp your header\'s socials by configuring these elements. Add new ones or remove the unnecessary ones by clicking the appropriate buttons in the element\'s settings. Our drag and drop feature allows you to rearrange them quickly.', 'xstore-core' ),
            'section'         => 'header_socials',
			'priority'        => 4,
			'dynamic'         => false,
			'row_label'       => array(
			...
			'fields'          => array(
				...
				'social_url'  => array(
					...
					'description' => esc_html__( 'Enter your social media account link for this purpose.', 'xstore-core' ),
					'default'     => '#',
				),
				'social_icon' => array(
					'type'    => 'select',
