...
<?php
    ...
    if ( $element_options['product_size_guide_section_et-desktop'] != '' ) {
        if ( defined( 'ELEMENTOR_VERSION' ) && is_callable( 'Elementor\Plugin::instance' ) ) {
            $elementor_instance = Elementor\Plugin::instance();
            $elementor_instance->frontend->get_builder_content_for_display( (int)$element_options['product_size_guide_section_et-desktop'] );
        }
    }
?>
