...
add_filter( 'et/customizer/add/fields/account', function ( $fields ) use ( $separators, $strings, $choices, $sep_style, $menu_settings, $box_models ) {
	...
	$args = array(
		...
		'account_content_type_et-desktop'   => array(
            ...
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-account content. There are three options available for you: Dropdown, Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ) . '<br/>' .
                sprintf(esc_html__( 'Note: To use dropdown option, please set up %s plugin', 'xstore-core' ), '<a href="https://wordpress.org/plugins/woocommerce/" target="_blank" rel="nofollow">'.esc_html__('WooCommerce', 'xstore-core').'</a>'),
			'section'         => 'account',
			'default'         => 'dropdown',
			'choices'         => array(
		...
		'account_content_type_et-mobile'    => array(
            ...
            'label'           => esc_html__( 'Content type', 'xstore-core' ),
            'tooltip'  => esc_html__( 'Choose the type of content for the mini-account content. There are few options available for you: Dropdown, Off-Canvas and None (if you don\'t want to have mini-content shown for this element).', 'xstore-core' ),
			'section'         => 'account',
			'default'         => 'off_canvas',
			'multiple'        => 1,
			'choices'         => array(
		...
		'account_label_separator'              => array(
			...
			'section'  => 'account',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-users"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Title', 'xstore-core' ) . '</span></div>',
			'priority' => 10,
		),
		...
		'account_label_username'               => array(
            ...
            'tooltip'   => esc_html__('If a customer is logged in, his username will be displayed instead of the default title.', 'xstore-core'),
			'section'         => 'account',
			'default'         => "0",
			'active_callback' => array(
				array(
		...
		'account_text'                         => array(
            ...
            'tooltip'   => esc_html__( 'Enter the text you would like to display for customers who are not logged in. The default value is "Sign In".', 'xstore-core' ),
			'section'   => 'account',
		...
		'account_logged_in_text'               => array(
            ...
            'tooltip'   => esc_html__( 'Enter the text you would like to display for customers who are logged in. The default value is "My account".', 'xstore-core' ),
			'section'         => 'account',
		...
		'account_content_dropdown_separator'            => array(
			...
			'section'         => 'account',
			'default'         => '<div style="' . $sep_style . '"><span class="dashicons dashicons-images-alt"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Dropdown', 'xstore-core' ) . '</span></div>',
			'priority'        => 10,
			'active_callback' => array(
				array(
