...
$element_options['newsletter_preloaded_content_et-desktop'] = get_theme_mod( 'newsletter_preloaded_content_et-desktop', 0 );

$element_options['classes'] = array();
if ($element_options['newsletter_preloaded_content_et-desktop']) {
	$element_options['classes'][] = 'loaded';
	add_action( 'after_page_wrapper', function(){
		echo '<span class="et_b_header-newsletter-preloaded">' . et_b_newsletter_content() . '</span>';
	}, 30 );
}
?>

<div class="et_element et_b_header-newsletter et-popup_toggle align-items-center flex-inline pointer <?php echo implode( ' ', $element_options['classes'] ); ?>" <?php echo implode( ' ', $element_options['attributes'] ); ?>>
