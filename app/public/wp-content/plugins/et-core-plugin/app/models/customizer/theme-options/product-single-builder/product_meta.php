...
add_filter( 'et/customizer/add/fields/product_meta', function ( $fields ) use ( $separators, $strings, $choices ) {
	...
	$args = array(
		...
		'product_meta_content'           => array(
            ...
            'tooltip' => esc_html__('Easily reorder, enable, and disable elements to create a truly distinctive visual design for your customers.', 'xstore-core'),
			'section'     => 'product_meta',
			'priority'    => 10,
		...
		// product_meta_custom_content separator
		'product_meta_custom_content_separator'   => array(
			'name'     => 'product_meta_custom_content_separator',
			'type'     => 'custom',
			'settings' => 'product_meta_custom_content_separator',
			'section'  => 'product_meta',
			'default'  => $separators['custom_content'],
			'active_callback' => array(
				array(
					'setting'  => 'product_meta_content',
					'operator' => 'in',
					'value'    => 'custom',
				),
			)
		...
		// product_meta_custom_content
		'product_meta_custom_content'               => array(
			'name'            => 'product_meta_custom_content',
			'type'            => 'editor',
			'settings'        => 'product_meta_custom_content',
			'label'           => esc_html__( '"Custom" element content', 'xstore-core' ),
			'tooltip'         => esc_html__('Content of "Custom" product meta element.', 'xstore-core'),
			'section'         => 'product_meta',
			'default'         => '',
			'active_callback' => array(
				array(
		...
		'product_meta_color_01_custom_et-desktop' => array(
			...
			'tooltip' => esc_html__('Choose the color to be applied to this element\'s titles and links when the mouse is hovered over them.', 'xstore-core'),
			'section'   => 'product_meta',
			'choices'   => array(
				'alpha' => true
			),
		...
		'product_meta_color_02_custom_et-desktop'     => array(
            ...
            'tooltip' => esc_html__('Choose the color to be applied to this element\'s links.', 'xstore-core'),
			'section'   => 'product_meta',
			'choices'   => array(
				'alpha' => true
			),
