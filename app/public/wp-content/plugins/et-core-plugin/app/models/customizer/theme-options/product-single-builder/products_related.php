...
add_filter( 'et/customizer/add/fields/products_related', function ( $fields ) use ( $separators, $product_settings, $strings, $sep_style, $choices ) {
	$args = array();
	...
	$args = array(
		...
		'products_related_type_et-desktop'                  => array(
            ...
            'tooltip'  => esc_html__('Choose the design type for the related products.', 'xstore-core'),
			'section'  => 'products_related',
			'default'  => 'slider',
			'multiple' => 1,
		...
		'products_related_per_view_et-desktop'              => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of products displayed for related products.', 'xstore-core' ),
			'section'  => 'products_related',
			'default'  => 4,
			'choices'  => array(
				'min'  => '1',
		...
		'products_related_per_view_et-mobile'               => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of products displayed for related products carousel.', 'xstore-core' ),
			'section'  => 'products_related',
			'default'  => 2,
			'choices'  => array(
				'min'  => '1',
		...
		'products_related_limit_et-desktop'                 => array(
            ...
            'tooltip'     => esc_html__( 'Use this option to limit the maximum number of products displayed for related products.', 'xstore-core' ),
			'section'  => 'products_related',
			'default'  => 7,
			'choices'  => array(
				'min'  => '1',
		...
		'products_related_out_of_stock_et-desktop'          => array(
			...
			'tooltip' => esc_html__('Enable this option to hide products that are out of stock in related products.', 'xstore-core'),
			'section'  => 'products_related',
			'default'  => 0,
		),
        ...
        'products_related_sale_label_et-desktop'            => array(
            ...
            'tooltip' => esc_html__('Enable this option to hide "Sale" label for products in related products.', 'xstore-core'),
            'section'  => 'products_related',
            'default'  => 1,
        ),

        'products_related_title_style_separator' => array(
            'name' => 'products_related_title_style_separator',
            'type' => 'custom',
            'settings' => 'products_related_title_style_separator',
            'section' => 'products_related',
