...
<?php
	$data = json_decode( get_theme_mod( 'header_mobile_bottom_elements', '' ), true );
	...
	$header_options['class'] = get_theme_mod( 'bottom_header_sticky_et-mobile', '0' ) ? 'sticky' : '';
...
<div class="header-bottom-wrapper <?php echo esc_attr($header_options['class']); ?>">
	<div class="header-bottom" data-title="<?php esc_html_e( 'Header bottom', 'xstore-core' ); ?>">
		<div class="et-row-container<?php echo !(get_theme_mod( 'bottom_header_wide_et-mobile' )) ? ' et-container' : ''; ?>">
