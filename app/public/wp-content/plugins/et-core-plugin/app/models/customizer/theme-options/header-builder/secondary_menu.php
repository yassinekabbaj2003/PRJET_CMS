...
add_filter( 'et/customizer/add/fields/main_menu_2', function ( $fields ) use ( $separators, $strings, $choices, $menu_settings ) {
    ...
    $args = array(
        ...
        'menu_2_item_style_et-desktop'          => array(
            ...
            'label'           => $menu_settings['strings']['label']['style'],
            'tooltip'         => $menu_settings['strings']['description']['style'],
            'section'         => 'main_menu_2',
            'default'         => 'underline',
        ...
        'menu_2_item_dots_separator_et-desktop' => array(
            ...
            'tooltip'         => $menu_settings['strings']['description']['sep_type'],
            'section'         => 'main_menu_2',
            'default'         => '2022',
        ...
        'menu_2_one_page'  => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['one_page'],
            'section'         => 'main_menu_2',
            'default'         => '0',
            'transport'       => 'postMessage',
            'partial_refresh' => array(
        ...
        'menu_2_dropdown_full_width'           => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['menu_dropdown_full_width'],
            'section'         => 'main_menu_2',
            'default'         => '0',
            'transport'       => 'postMessage',
            'partial_refresh' => array(
        ...
        'menu_2_arrows'                        => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['arrows'],
            'section'   => 'main_menu_2',
            'default'   => 1,
            'transport' => 'postMessage',
            'js_vars'   => array(
        ...
        'menu_2_item_color_custom_et-desktop'  => array(
            ...
            'tooltip'         => $menu_settings['strings']['description']['color'],
            'section'         => 'main_menu_2',
            'default'         => '#555555',
            'active_callback' => array(
                array(
        ...
        'menu_2_item_hover_color_custom_et-desktop'            => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['hover_color'],
            'section'   => 'main_menu_2',
            'default'   => '#222222',
            'transport' => 'auto',
            'output'    => array(
        ...
        // menu_2_item_line_hover_color_custom
        'menu_2_item_line_hover_color_custom_et-desktop'       => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['line_color'],
            'section'         => 'main_menu_2',
            'default'         => '#555555',
            'choices'         => array(
                'alpha' => true
            ...
            'output'          => array(
                array(
                    'context'  => array( 'editor', 'front' ),
                    'element'  => '.header-main-menu2.et_element-top-level .menu > li > a:before, .header-main-menu2.et_element-top-level .menu > .current-menu-item > a:before, .header-main-menu2.et_element-top-level .menu > .opened > a:before',
                    'property' => 'background-color'
                ),
            ),
            'priority'        => 17,
        ...
        'menu_2_item_dots_color_et-desktop'                    => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['dots_color'],
            'section'         => 'main_menu_2',
            'default'         => 'current',
        ...
        // menu_2_item_arrow_hover_color_custom
        'menu_2_item_arrow_hover_color_custom_et-desktop'      => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['arrow_color'],
            'section'         => 'main_menu_2',
            'default'         => '#555555',
            'choices'         => array(
                'alpha' => true
        ...
        // menu_2_item_background_hover_color_custom
        'menu_2_item_background_hover_color_custom_et-desktop' => array(
            ...
            'tooltip'     => $menu_settings['strings']['description']['bg_hover_color'],
            'section'         => 'main_menu_2',
            'default'         => '#e1e1e1',
            'choices'         => array(
                'alpha' => true
            ...
            'output'          => array(
                array(
                    'context'  => array( 'editor', 'front' ),
                    'element'  => '.header-main-menu2.et_element-top-level.menu-items-custom .menu > li > a:hover, .header-main-menu2.et_element-top-level.menu-items-custom .menu > .current-menu-item > a, .header-main-menu2.et_element-top-level.menu-items-custom .menu > .opened > a',
                    'property' => 'background-color'
                ),
            ),
            'priority'        => 21,
        ...
        'menu_2_item_box_model_et-desktop'                 => array(
            ...
            'tooltip' => $menu_settings['strings']['description']['item_box_model'],
        ...
        'menu_2_nice_space_et-desktop'                     => array(
            ...
            'tooltip'  => $menu_settings['strings']['description']['nice_space'],
            'section'  => 'main_menu_2',
            'default'  => '0',
            'priority' => 23,
        ),
        ...
        // menu_2_item_border_hover_color_custom
        'menu_2_item_border_hover_color_custom_et-desktop' => array(
            ...
            'output'          => array(
                array(
                    'context'  => array( 'editor', 'front' ),
                    'element'  => '.header-main-menu2.et_element-top-level .menu > li > a:hover, .header-main-menu2.et_element-top-level .menu > .current-menu-item > a, .header-main-menu2.et_element-top-level .menu > .opened > a',
                    'property' => 'border-color',
                ),
            ),
            'priority'        => 26,
        ...
        'go_to_section_secondary_menu_2'                 => array(
            'name'     => 'go_to_section_secondary_menu_2',
            'type'     => 'custom',
            'settings' => 'go_to_section_secondary_menu_2',
            'label'       => esc_html__('Dropdown menus', 'xstore-core'),
            'tooltip' => esc_html__('Configure dropdown menus settings', 'xstore-core'),
            'section'  => 'main_menu_2',
            'default'  => '<span class="et_edit" data-parent="menu_dropdown" data-section="menu_dropdown_style_separator" style="padding: 6px 7px; border-radius: 5px; background: var(--customizer-dark-color, #222); color: var(--customizer-white-color, #fff); font-size: calc(var(--customizer-ui-content-zoom, 1) * 12px); text-align: center;">' . esc_html__( 'Configure dropdowns', 'xstore-core' ) . '</span>',
            'priority' => 27,
        ),
