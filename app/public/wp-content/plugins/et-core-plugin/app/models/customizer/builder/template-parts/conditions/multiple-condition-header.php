...
<div class="et_conditions-actions text-left">
    <span class="et_condition-action et_condition-add et_button et_button-lg et_button-lightgrey hidden" data-action="add"><span class="dashicons dashicons-no-alt" style="transform: rotate(45deg);"></span><?php echo esc_html__('Add Condition', 'xstore-core'); ?></span>
    <span class="et_condition-action et_button et_button-lg et_button-green" data-action="save_all" style="display: block; width: calc(var(--customizer-ui-content-zoom, 1) * 31px); margin-top: calc(var(--customizer-ui-content-zoom, 1) * 40px);"><?php echo esc_html__('Save', 'xstore-core'); ?></span>
</div>
