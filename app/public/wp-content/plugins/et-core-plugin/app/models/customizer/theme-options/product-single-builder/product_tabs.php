...
add_filter( 'et/customizer/add/fields/product_tabs', function ( $fields ) use ( $separators, $strings, $choices, $sep_style ) {
	...
	$args = array(
		...
		'product_tabs_type_et-desktop'        => array(
            ...
            'tooltip' => esc_html__('Using this option, you can choose a design type for this element.', 'xstore-core'),
			'section'  => 'product_tabs',
			'default'  => 'underline',
			'priority' => 10,
			'choices'  => array(
		...
		'product_tabs_style_et-desktop'       => array(
            ...
            'tooltip'         => esc_html__( 'Choose the direction for tabs element.', 'xstore-core' ),
			'section'         => 'product_tabs',
			'default'         => 'horizontal',
			'choices'         => array(
		...
		'product_tabs_sortable'               => array(
            ...
            'tooltip' => esc_html__('Easily reorder, enable, and disable specific tabs to create a unique visual design and to display only the most necessary tabs with their associated information for your customers.', 'xstore-core'),
			'section'     => 'product_tabs',
		...
		'product_first_tab_opened_et-desktop' => array(
			...
			'tooltip' => esc_html__('Enable this option to make the first tab open by default when customers open the page.', 'xstore-core'),
			'section'         => 'product_tabs',
			'default'         => 0,
			'active_callback' => array(
				array(
		...
		'product_tabs_opened_et-desktop'            => array(
			...
			'label'           => esc_html__( 'All tabs opened', 'xstore-core' ),
            'tooltip' => esc_html__('Enable this option to make all tabs open by default when customers open the page.', 'xstore-core'),
			'section'         => 'product_tabs',
			'default'         => 0,
			'active_callback' => array(
				array(
		...
		'product_reviews_in_two_columns_et-desktop' => array(
			...
			'label'    => esc_html__( 'Separated reviews', 'xstore-core' ),
            'tooltip'  => esc_html__( 'Use this option to separate the product reviews into two columns: one for reviews posted by customers and another for the new form to write a review.', 'xstore-core' ),
			'section'  => 'product_tabs',
			'default'  => 1,
		),
		...
		'product_reviews_et-desktop'                => array(
			...
			'label'           => esc_html__( 'Detached reviews', 'xstore-core' ),
            'tooltip'  => esc_html__( 'Use this option to remove the reviews from the tabs area and place them directly beneath the tabs.', 'xstore-core' ),
			'section'         => 'product_tabs',
			'default'         => 0,
        ...
        'product_reviews_collapsed_et-desktop'                         => array(
            ...
            'label'           => esc_html__( 'Collapsed reviews', 'xstore-core' ),
            'tooltip'     => esc_html__( 'Enable this option to make the reviews only appear when the button is clicked.', 'xstore-core' ),
            'section'         => 'product_tabs',
            'default'         => 0,
            'active_callback' => function () {
		...
		'product_reviews_collapsed_et-mobile'                         => array(
			...
			'label'           => esc_html__( 'Collapsed reviews', 'xstore-core' ),
			'tooltip'     => esc_html__( 'Enable this option to make the reviews only appear when the button is clicked on mobile devices.', 'xstore-core' ) . '<br/>' .
                sprintf(esc_html__('To properly identify mobile devices, we use the WordPress function "%1s". However, this function may conflict with cache plugins.', 'xstore-core' ),
		...
		'product_tabs_navigation_style_separator'                     => array(
			...
			'section'  => 'product_tabs',
			'default'  => '<div style="' . $sep_style . '"><span class="dashicons dashicons-admin-customizer"></span> <span style="padding-inline-start: 5px;">' . esc_html__( 'Tabs navigation', 'xstore-core' ) . '</span></div>',
		),
		...
		'product_tabs_navigation_active_color_custom_et-desktop'      => array(
            ...
            'tooltip'     => esc_html__( 'Choose the color for the active navigation tab link.', 'xstore-core' ),
			'section'   => 'product_tabs',
			'default'   => '#000',
			'choices'   => array(
				'alpha' => true
		...
		'product_tabs_vertical_proportion_et-desktop'                 => array(
            ...
            'tooltip' => esc_html__( 'This controls the width of this element.', 'xstore-core' ),
			'section'         => 'product_tabs',
			'default'         => 20,
			'choices'         => array(
				'min'  => '1',
		...
		'product_tabs_scroll_et-desktop'                              => array(
            ...
            'tooltip' => esc_html__( 'Enable this option to set the maximum height for the content of the tabs.', 'xstore-core' ) . '<br/>' .
                esc_html__('Info: If any content in your tabs is higher than the height you set in the option below, then a scrollbar will appear.', 'xstore-core'),
			'section'   => 'product_tabs',
			'default'   => 0,
			'transport' => 'postMessage',
			'js_vars'   => array(
		...
		'product_tabs_height_et-desktop'                              => array(
			...
			'label'       => esc_html__( 'Content max height', 'xstore-core' ),
            'tooltip'     => esc_html__( 'Set the maximum height for the content of the tabs.', 'xstore-core' ) . '<br/>' .
                esc_html__('Info: If any content in your tabs is higher than the height you set in the option below, then a scrollbar will appear.', 'xstore-core'),
//			'tooltip' => esc_html__( 'Works if option "Tabs content scroll" is enabled', 'xstore-core' ),
			'section'     => 'product_tabs',
			'default'     => 250,
			'choices'     => array(
				'min'  => 50,
		...
		'product_tabs_navigation_spacing_et-desktop'                  => array(
            ...
            'tooltip'   => esc_html__('With this option, you can set the distance value between navigation tabs displayed in the current element.', 'xstore-core'),
			'section'         => 'product_tabs',
			'default'         => 0,
			'choices'         => array(
				'min'  => '-1',
		...
		'product_tabs_accordion_navigation_spacing_et-desktop'        => array(
			...
			'label'           => esc_html__( 'Inner space between (px)', 'xstore-core' ),
            'tooltip'   => esc_html__('With this option, you can set the inner spacing value for navigation tabs displayed in the current element.', 'xstore-core'),
			'section'         => 'product_tabs',
			'default'         => 10,
			'choices'         => array(
				'min'  => '0',
		...
		'product_tabs_custom_tab_01_title_et-desktop'                 => array(
            ...
            'tooltip' => esc_html__('Customize the title text displayed for "Custom tab 01".', 'xstore-core'),
			'section'  => 'product_tabs',
...
//			'label'           => sprintf( esc_html__( 'Choose %1s', 'xstore-core' ), '<a href="' . etheme_documentation_url('47-static-blocks', false) . '" target="_blank" style="color: var(--customizer-dark-color, #555)">' . esc_html__( 'static block', 'xstore-core' ) . '</a>' ),
		...
		'product_tabs_custom_tab_02_title_et-desktop'                 => array(
            ...
            'tooltip' => esc_html__('Customize the title text displayed for "Custom tab 02".', 'xstore-core'),
			'section'  => 'product_tabs',
			'default'  => '',
		),
