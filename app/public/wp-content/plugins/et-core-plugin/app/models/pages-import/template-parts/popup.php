...
<div class="et_response-holder">
	...
	<div class="et_panel-popup et_popup-import-single-page size-lg">
		<span class="et_close-popup et-button-cancel et-button">
            <svg version="1.1" class="origin-size-svg" xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 32 32" fill="currentColor" style="font-size: 16px;">
		...
		<div class="et_popup-import-content">
			<div class="et_popup-step et_step-import">
                ...
                <p class="flex justify-content-between">
                    <input
                        type="text"
                        id="et_single-page-import"
                        name="et_single-page-import"
                        placeholder="<?php esc_html_e( 'Example: https://xstore.8theme.com/team-members/', 'xstore-core' ); ?>"
                        value=""
                        style="width: 100%;margin: 0 -1px 0 0;padding: 11px 10px 10px;outline: none;border-radius: 3px 0 0 3px; line-height: 1px;"
                    >
                    ...
                    <input type="hidden" name="nonce_etheme_page-import-sliders" value="<?php echo wp_create_nonce( 'etheme_page-import-sliders' ); ?>">
                </p>
            ...
            <style>
                ...
                /*,.et_step-plugins.ajax-processing:after*/
                {
                    position: absolute;
                    top: calc(50% - 9px);
                    left: calc(50% - 9px);
