...
class Etheme_Single_pages_Import {
    ...
    public function template() {
        ob_start();
            require_once( ET_CORE_DIR . 'app/models/pages-import/template-parts/' . sanitize_file_name($this->post['template']) . '.php' );
    ...
    public function import_page_sliders(){
	    ...
	    check_ajax_referer('etheme_page-import-sliders', 'security');
