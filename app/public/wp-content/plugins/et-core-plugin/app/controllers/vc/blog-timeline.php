 ...
 */
class Blog_Timeline extends VC {

	function hooks() {

		add_filter( 'vc_autocomplete_et_blog_timeline_include_callback', 'vc_include_field_search', 10, 1 );
		add_filter( 'vc_autocomplete_et_blog_timeline_include_render', 'vc_include_field_render', 10, 1 );

		add_filter( 'vc_autocomplete_et_blog_timeline_taxonomies_callback', 'vc_autocomplete_taxonomies_field_search', 10, 1 );
		add_filter( 'vc_autocomplete_et_blog_timeline_taxonomies_render', 'vc_autocomplete_taxonomies_field_render', 10, 1 );

		add_filter( 'vc_autocomplete_et_blog_timeline_exclude_filter_callback', 'vc_autocomplete_taxonomies_field_search', 10, 1 );
		add_filter( 'vc_autocomplete_et_blog_timeline_exclude_filter_render', 'vc_autocomplete_taxonomies_field_render', 10, 1 );

		add_filter( 'vc_autocomplete_et_blog_timeline_exclude_callback', 'vc_exclude_field_search', 10, 1 );
		add_filter( 'vc_autocomplete_et_blog_timeline_exclude_render', 'vc_exclude_field_render', 10, 1 );

		$this->register_vc_blog_timeline();
	}

	function register_vc_blog_timeline() {
		...
		$params = array(
			...
			'description' => esc_html__( 'Display posts in time-line', 'xstore-core' ),
