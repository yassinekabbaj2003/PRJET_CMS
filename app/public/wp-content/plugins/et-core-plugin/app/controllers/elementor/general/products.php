        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'             => sprintf( esc_html__( 'This widget was deprecated since v4.1.3. Please, use %1s widgets instead.', 'xstore-core' ),
                    '<b>'.esc_html__('Products Grid', 'xstore-core').'</b>'.
                    ', <b>'.esc_html__('Products List', 'xstore-core').'</b> '.
                    esc_html__('or', 'xstore-core') . ' <b>'.esc_html__('Products Carousel', 'xstore-core').'</b>'),
