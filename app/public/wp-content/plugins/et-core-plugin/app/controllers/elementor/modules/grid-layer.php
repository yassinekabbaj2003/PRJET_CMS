...
class Grid_Layer {
	...
	public static function register_controls( $element ) {
        ...
        $site_container_width = get_theme_mod('site_width', get_option( 'elementor_container_width', 1140 ));
		...
		$element->add_responsive_control(
			...
			[
				...
				'devices' => [ 'desktop', 'tablet', 'mobile' ],
				'default' => [
					'size' => $site_container_width, // get_option( 'elementor_container_width', 1140 ),
					'unit' => 'px',
				],
				'desktop_default' => [
					'size' => $site_container_width,
					'unit' => 'px',
				],
				'tablet_default' => [
