...
class Ajax_Product extends \Elementor\Base_Data_Control {
	...
	public function content_template() {
		...
		<div class="elementor-control-field ajax-product-tab">
			...
			<# } #>
			<div class="elementor-control-input-wrapper elementor-control-unit-5 elementor-control-dynamic-switcher-wrapper" data-nonce="<?php echo wp_create_nonce( 'select2_ajax_control' ); ?>">
				<# var multiple = ( data.multiple ) ? 'multiple' : ''; #>
				<select id="<?php echo $control_uid; ?>" class="elementor-select2 elementor-control-tag-area" type="select2" {{ multiple }} data-setting="{{ data.name }}" placeholder="{{ view.getControlPlaceholder() }}">
