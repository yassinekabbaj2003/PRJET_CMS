...
/**
 * Archive Posts Timeline widget.
 *
 * @since      5.4
 * @package    ETC
 * @subpackage ETC/Controllers/Elementor
 */
class Posts_Timeline extends \ETC\App\Controllers\Elementor\General\Posts_Timeline {
    ...
    public function get_title() {
        return __( 'Archive Posts Timeline', 'xstore-core' );
    }
