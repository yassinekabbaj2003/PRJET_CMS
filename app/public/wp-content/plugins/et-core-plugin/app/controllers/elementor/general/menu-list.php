...
class Menu_List extends \Elementor\Widget_Base {
	...
	protected function register_controls() {
        ...
        $this->start_controls_tabs( 'menu_list_tabs_style' );

        $this->start_controls_tab(
            'menu_list_item_style_regular',
            [
        ...
        $this->start_controls_section(
            'menu_list_subitem_style_settings',
            [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label'         => __( 'Typography', 'xstore-core' ),
                'selector'      => '{{WRAPPER}} .subitem-title-holder  .menu-title',
                'separator'     => 'before',
            ]
        );

        $this->start_controls_tabs( 'menu_list_subitem_style_tabs' );

        $this->start_controls_tab(
            'menu_list_subitem_style_regular',
            [
                'label' => __( 'Regular', 'xstore-core' ),
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::COLOR,
                'selectors'    => [
                    '{{WRAPPER}} .subitem-title-holder .menu-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type'    => \Elementor\Controls_Manager::COLOR,
                'selectors'    => [
                    '{{WRAPPER}} .subitem-title-holder:hover .menu-title' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units' => [ 'px', '%' ],
                'selectors' => [
                    '{{WRAPPER}} .subitem-title-holder .menu-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
