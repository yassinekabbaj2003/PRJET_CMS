...
class Products extends \ETC\App\Controllers\Elementor\General\Product_Grid {
	...
	public function get_name() {
		return 'search-results-woocommerce-etheme_products';
	}
    ...
    public function get_title() {
        return __( 'Searched Products', 'xstore-core' );
    }
	...
	public function get_icon() {
        return 'eight_theme-elementor-icon et-elementor-products-grid et-elementor-search-results-widget-icon-only';
	}
