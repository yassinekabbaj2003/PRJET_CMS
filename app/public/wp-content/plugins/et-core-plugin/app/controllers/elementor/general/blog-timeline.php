 ...
 */
class Blog_Timeline extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Blog Timeline', 'xstore-core' );
	}
	...
	public function get_icon() {
		return 'eight_theme-elementor-icon et-elementor-blog-timeline';
	}
	...
	public function get_keywords() {
		return [ 'blog', 'blog-timeline', 'posts', 'cpt', 'item', 'loop', 'query', 'cards', 'custom post type' ];
	}
	...
	/**
	 * Register Blog Timeline widget controls.
	 *
	 * @since 2.1.3
	 * @access protected
	 */
	...
	/**
	 * Render Blog Timeline widget output on the frontend.
	 *
	 * @since 2.1.3
	 * @access protected
	 */
	protected function render() {
		...
		echo do_shortcode( '[et_blog_timeline 
