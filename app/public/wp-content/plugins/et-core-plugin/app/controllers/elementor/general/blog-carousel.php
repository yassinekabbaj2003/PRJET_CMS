	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            array(
                ...
                'raw'             => sprintf( esc_html__( 'This widget was deprecated since v4.1.3. Please, use %1s widgets instead.', 'xstore-core' ),
                    '<b>'.esc_html__('Posts', 'xstore-core').'</b>'.
                    ', <b>'.esc_html__('Posts Chess', 'xstore-core').'</b>'.
                    ', <b>'.esc_html__('Posts Timeline', 'xstore-core').'</b>'.
                    ', <b>'.esc_html__('Posts Tabs', 'xstore-core').'</b> '.
                    esc_html__('or', 'xstore-core') . ' <b>'.esc_html__('Posts Carousel', 'xstore-core').'</b>'),
