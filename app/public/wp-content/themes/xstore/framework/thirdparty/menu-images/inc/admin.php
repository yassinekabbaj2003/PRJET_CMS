...
class Nav_Menu_Images_Admin extends Nav_Menu_Images {
    ...
    $item->type_label = apply_filters('etheme_theme_author_name', '8Theme'). ' '. ucwords(strtolower( $item->type_label )) .' Options';
	...
	public static function filter_walker( $id, $item, $depth, $args ) { 
		...
		$output .= '<div class="et_item-popup"><div class="et_modal-header"><span class="title-heading">Menu options</span><i class="et-close-modal et-saveItem"></i></div><input type="hidden" name="nonce_etheme-etheme_update-menu-item" value="'.wp_create_nonce( 'etheme_update-menu-item' ).'"><div class="et_popup-content">';
