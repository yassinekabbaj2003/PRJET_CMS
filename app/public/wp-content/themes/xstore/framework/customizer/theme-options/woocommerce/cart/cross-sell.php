...
add_filter( $hook, function ( $fields ) {
	...
	$args = array(
		'cart_products_cross_sell_type_et-desktop'     => array(
            ...
            'tooltip'  => esc_html__('Choose the design type for the cross-sell products.', 'xstore'),
		...
		'cart_products_cross_sell_per_view_et-desktop' => array(
            ...
            'tooltip' => esc_html__( 'This controls the number of products displayed when cross-selling products.', 'xstore' ),
			'section'  => 'cart-cross-sell',
			'default'  => 4,
			'choices'  => array(
				'min'  => '1',
		...
		'cart_products_cross_sell_limit_et-desktop'    => array(
            ...
            'tooltip'     => esc_html__( 'Use this option to limit the maximum number of products displayed when cross-selling products.', 'xstore' ),
			'section'  => 'cart-cross-sell',
			'default'  => 7,
			'choices'  => array(
				'min'  => '1',
