...
(function($, api) {
	...
	api.bind('preview-ready', function() {
		...
		var elements = {
			...
			'.single-product-builder .sidebar-widget[data-customize-partial-id]' : { 'title': 'Sidebar widget', 'section' : 'single_product_layout' },
			...
			'.single-product-builder .et-availability-notify-popup .et-popup-content, .single-product-builder .xstore-waitlist-single' : { 'title' : 'Waitlist', 'section' : 'product_waitlist' },
			...
			'.etheme-before-adc-content' : { 'title' : 'Before cart form', 'section' : 'product_cart_form' },
			'.etheme-after-adc-content' : { 'title' : 'After cart form', 'section' : 'product_cart_form' },
