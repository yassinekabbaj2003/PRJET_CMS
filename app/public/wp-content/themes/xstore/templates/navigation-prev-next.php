 ...
 *
 * Override this template by copying it to yourtheme/templates/navigation-prev-next.php
 * @author 	   8theme
...
?>
    <div class="posts-navigation<?php echo !apply_filters('etheme_elementor_edit_mode', false) ? ' hidden' : ''; ?>">
