...
/**
 * The template for displaying single product booking content
 *
 * Override this template by copying it to yourtheme/woocommerce/single-product-content-booking.php
 *
 * @author 	   8theme
