...
/**
 * The template for displaying single product fixed content
 *
 * Override this template by copying it to yourtheme/woocommerce/single-product-content-fixed.php
 *
 * @author 	   8theme
