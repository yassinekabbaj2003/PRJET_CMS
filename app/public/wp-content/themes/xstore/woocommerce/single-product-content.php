...
/**
 * The Template for displaying single product content (base content)
 *
 * Override this template by copying it to yourtheme/woocommerce/single-product-content.php
 *
 * @author 	   8theme
