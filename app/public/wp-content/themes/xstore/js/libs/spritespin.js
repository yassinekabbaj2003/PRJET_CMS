 ...
 *
 * @class      ThreeSixty
 * @package    three-sixty-image.js
 * @since      8.0.12
 * @author     Alexander Gräfenstein
 * @link       https://github.com/giniedp/spritespin
 * @version    4.1.0
 * @license    MIT license
 *
 * modifications by Stas
 * replaced prefix '.spritespin-' for
 * .spritespin-progress, .spritespin-progress-label, .spritespin-progress-bar, .spritespin-canvas, .spritespin-stage with
 * .etheme-360-
 */
...
(function (global, factory) {
    ...
    function create(options) {
        ...
        // build inner html
        // <div>
        //   <div class='etheme-360-product-viewer-stage'></div>
        //   <canvas class='etheme-360-product-viewer-canvas'></canvas>
        // </div>
        target
            .empty()
            .addClass('spritespin-instance')
            .append("<div class='etheme-360-product-viewer-stage'></div>");
        // add the canvas element if canvas rendering is enabled and supported
        if (data.renderer === 'canvas') {
            var canvas = document.createElement('canvas');
            if (!!(canvas.getContext && canvas.getContext('2d'))) {
                data.canvas = $$2(canvas).addClass('etheme-360-product-viewer-canvas');
        ...
        data.target = target;
        data.stage = target.find('.etheme-360-product-viewer-stage');
        // store the data
...
// tslint:disable:only-arrow-functions
    ...
    (function () {
        ...
        function onInit(e, data) {
            ...
            state.stage.find('.etheme-360-product-viewer-progress-label')
                .text("0%")
                .css({ 'text-align': 'center' });
            state.stage.find('.etheme-360-product-viewer-progress-bar').css({
                width: "0%"
            });
